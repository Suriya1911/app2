...
with tab3:
    ...
    if records:
        ...
        with col2:
            ...
            <head>
                <style>
                    body { font-family: 'Courier New', monospace; margin: 15px; font-size: 5px; }
                    h1 { text-align: center; color: #2c3e50; font-weight: 300; letter-spacing: 1px; margin-bottom: 8px; font-size: 14px; }
                    .meta { text-align: center; color: #7f8c8d; margin-bottom: 15px; font-size: 8px; }
        ...
        with col4:
            ...
            <head>
                <style>
                    body { font-family: 'Courier New', monospace; margin: 15px; font-size: 5px; }
                    h1 { text-align: center; color: #27ae60; font-weight: 300; letter-spacing: 1px; margin-bottom: 8px; font-size: 14px; }
                    .meta { text-align: center; color: #7f8c8d; margin-bottom: 15px; font-size: 8px; }
                    table { width: 100%; border-collapse: collapse; margin-top: 8px; table-layout: fixed; }
                    th, td { 
                        border: 1px solid #000; 
